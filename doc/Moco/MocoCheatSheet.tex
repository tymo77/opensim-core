...
\begin{lstlisting}[style=Matlab-editor, basicstyle=\mlttfamily\small, linewidth=0.48\textwidth]
problem.setTimeInfo(MocoInitialBounds(0), MocoFinalBounds(0.5, 1.5));
\end{lstlisting}
...
\vspace{-15pt}
    \begin{align*}
        ...
        \mbox{subject to}
         ...
         & \textcolor{dblue}{t_0 \in [t_{0,L}, t_{0,U}] \quad\quad  t_f \in [t_{f,L}, t_{f,U}]} && \texttt{\textcolor{dblue}{problem.setTimeInfo()}} \\
